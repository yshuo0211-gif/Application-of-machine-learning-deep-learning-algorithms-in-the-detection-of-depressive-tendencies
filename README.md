# Application of Machine Learning & Deep Learning Algorithms in Detecting Depressive Tendencies
...
![Raw data distribution](picture/Data%20distribution.png)
![Data distribution(processed)](picture/Data%20distribution(processed).png)
...
![Text data(processed)](picture/Data%20overview%202(processed).png)
...
![Text data(processed)](picture/Data%20overview%203(processed).png)
...
![Traditional machine learning model comparison 1](picture/传统模型/model%20comparison.png)
...
![Decision Tree Oversampling](picture/传统模型/Decision%20Tree%20-%20Oversampling.png)
![Decision Tree - Oversampling - ROC](picture/传统模型/Decision%20Tree%20-%20Oversampling%20-%20ROC.png)
![Decision Tree - Oversampling - Confusion Matrix](picture/传统模型/Decision%20Tree%20-%20Oversampling%20-%20Confusion%20Matrix.png)
...
![Traditional machine learning model comparison 2](picture/集成学习/model%20comparison.png)
...
![XGBoost - ROC](picture/集成学习/XGBoost%20-%20ROC.png)
![XGBoost - Confusion Matrix](picture/集成学习/XGBoost%20-%20Confusion%20Matrix.png)
...
![Deep learning model comparison](picture/Transformer/model%20comparison.png)
...
![Training process](picture/Transformer/Transformer%20-%20Training%20process.png)

Following are the results of the simplified model after parameter adjustment. The specific model structure of Transformer is in the [code folder](code).

![Transformer](picture/Transformer/Transformer.png)
![Transformer - ROC](picture/Transformer/Transformer%20-%20ROC.png)
![Transformer- Confusion Matrix](picture/Transformer/Transformer%20-%20Confusion%20Matrix.png)
...
![Decision Tree - Oversampling - Top10 Characteristics](picture/传统模型/Decision%20Tree%20-%20Oversampling%20-%20Top10%20Characteristics.png)
![XGBoost - Top10 Characteristics](picture/集成模型/XGBoost%20-%20Top10%20Characteristics.png)
...
 
![XGBoost - SHAP overview diagram](picture/集成学习/XGBoost%20-%20SHAP%20overview%20diagram.png)
![XGBoost - SHAP dependency graph 1](picture/集成学习/XGBoost%20-%20SHAP%20dependency%20graph%201.png)
![XGBoost - SHAP dependency graph 2](picture/集成学习/XGBoost%20-%20SHAP%20dependency%20graph%202.png)
![XGBoost - SHAP dependency graph 3](picture/集成学习/XGBoost%20-%20SHAP%20dependency%20graph%203.png)
![XGBoost - SHAP force graph](picture/集成学习/XGBoost%20-%20SHAP%20force%20graph.png)
 
...
![XGBoost - hyper parameter tuned](picture/集成学习/XGBoost%20-%20hyper%20parameter%20tuned.png)
![XGBoost - hyper parameter tuned - ROC](picture/集成学习/XGBoost%20-%20hyper%20parameter%20tuned%20-%20ROC.png)
![XGBoost - hyper parameter tuned - Confusion Matrix](picture/集成学习/XGBoost%20-%20hyper%20parameter%20tuned%20-%20Confusion%20Matrix.png)
